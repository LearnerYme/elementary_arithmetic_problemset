...
plus_label = tk.Label(frame_ar_p, text='加法设置', font=('宋体',20))
subtract_label = tk.Label(frame_ar_s, text='减法设置', font=('宋体',20))
multiply_label = tk.Label(frame_ar_m, text='乘法设置', font=('宋体',20))
divide_label = tk.Label(frame_ar_d, text='除法设置', font=('宋体',20))
...
plus_high_label = tk.Label(frame_ar_p, text='最大值：')
...
plus_maximum_label = tk.Label(frame_ar_p, text='结果最大值：')
...
subtract_num_label = tk.Label(frame_ar_s, text='题目数量：')
...
subtract_low_label = tk.Label(frame_ar_s, text='最小值：')
...
subtract_high_label = tk.Label(frame_ar_s, text='最大值：')
...
subtract_neg_check = tk.Checkbutton(frame_ar_s, text='允许负数结果', variable=subtract_neg_bool)
...
multiply_num_label = tk.Label(frame_ar_m, text='题目数量：')
...
multiply_low_label = tk.Label(frame_ar_m, text='最小值：')
...
multiply_high_label = tk.Label(frame_ar_m, text='最大值：')
...
multiply_maximum_label = tk.Label(frame_ar_m, text='结果最大值：')
...
multiply_marker_label = tk.Label(frame_ar_m, text='乘号使用字符： ')
...
divide_num_label = tk.Label(frame_ar_d, text='题目数量：')
...
divide_maximum_label = tk.Label(frame_ar_d, text='结果最大值：')
...
divide_maximum_divisor_label = tk.Label(frame_ar_d, text='除数最大值：')
...
divide_marker_label = tk.Label(frame_ar_d, text='除号使用字符： ')
...
divide_decimal_check = tk.Checkbutton(frame_ar_d, text='小数结果', variable=divide_decimal_bool)
divide_decimal_label = tk.Label(frame_ar_d, text='无效选项，功能开发中')
divide_mod_bool = tk.BooleanVar()
divide_mod_bool.set(divide_mod_json)
divide_mod_check = tk.Checkbutton(frame_ar_d, text='要求余数', variable=divide_mod_bool)
divide_mod_label = tk.Label(frame_ar_d, text='若不勾选，只会产生整除题')
...
def save_cmd():
    ...
    status_window.insert(tk.INSERT, '已保存设置！')     
    return
save_button = tk.Button(frame_sgr, text='保存设置', command=save_cmd)
save_button.grid(row=0, column=0)
#generate
def generate_cmd():
    os.system('python3 problemset.py')
    status_window.delete(0.0, tk.END)
    status_window.insert(tk.INSERT, '已生成题目集！')    
    return
generate_button = tk.Button(frame_sgr, text='生成题集', command=generate_cmd)
...
def reset_cmd():
    ...
    status_window.delete(0.0, tk.END)
    status_window.insert(tk.INSERT, '已重置所有设置！')

    return
reset_button = tk.Button(frame_sgr, text='重置设置', command=reset_cmd)
